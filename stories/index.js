...
storiesOf("InterviewerListItem", module)
  ...
  .add("Unselected", () => <InterviewerListItem value={interviewer.id} name={interviewer.name} avatar={interviewer.avatar} />)
  .add("Selected", () => <InterviewerListItem value={interviewer.id} name={interviewer.name} avatar={interviewer.avatar} selected />)
  .add("Clickable", () => <InterviewerListItem value={interviewer.id} name={interviewer.name} avatar={interviewer.avatar} setInterviewer={(event) => action("setInterviewer")(interviewer.id)} />);
...
storiesOf("InterviewerList", module)
  ...
  .add("Preselected", () => <InterviewerList interviewers={interviewers} interviewer={3} onChange={action("setInterviewer")} />);
...
storiesOf("Appointment", module)
  ...
  .add("Edit", () => <Form name={interviewer.name} interviewers={interviewers} interviewer={interviewer.id} onSave={action("onSave")} onCancel={action("onCancel")} />)
